    ...
    <header className="w-full relative z-40">
      ...
      <div className="relative backdrop-blur-2xl bg-gradient-to-r from-slate-900/80 via-slate-800/60 to-slate-900/80 border-b border-white/10 shadow-lg shadow-black/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 py-3 md:py-4">
            ...
            <div className="flex-shrink-0 group">
              <div className="relative">
                ...
                <img
                  ...
                  className="relative h-14 sm:h-16 md:h-20 w-auto object-contain drop-shadow-2xl transition-transform duration-500 group-hover:scale-105"
                />
              </div>
            </div>
            ...
            <div className="flex-1 text-center leading-tight px-4">
              <div className="inline-block relative mb-1">
                ...
                <p className="relative text-[10px] sm:text-[11px] md:text-xs font-medium tracking-wider uppercase bg-gradient-to-r from-gray-300 via-white to-gray-300 bg-clip-text text-transparent">
                  Marathwada Shikshan Prasarak Mandal's
                </p>
              </div>
              <h1 className="mt-1 text-base sm:text-lg md:text-xl lg:text-2xl font-bold tracking-tight bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent drop-shadow-lg">
              ...
              <div className="mt-1 flex items-center justify-center gap-2">
                <div className="h-px w-8 sm:w-12 bg-gradient-to-r from-transparent via-indigo-400/50 to-transparent"></div>
                <span className="text-[10px] sm:text-xs text-gray-400 font-medium tracking-wide">Since 2011</span>
                <div className="h-px w-8 sm:w-12 bg-gradient-to-r from-transparent via-indigo-400/50 to-transparent"></div>
              </div>
            </div>
            ...
            <div className="flex-shrink-0 flex items-center justify-center gap-3 sm:gap-4">
              <div className="group relative">
                ...
                <img
                  ...
                  className="relative h-10 sm:h-12 md:h-14 w-auto object-contain drop-shadow-xl transition-transform duration-500 group-hover:scale-110"
                />
              </div>
              <div className="group relative">
      ...
      <div className="relative backdrop-blur-md bg-gradient-to-r from-slate-950/60 via-slate-900/40 to-slate-950/60 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-2.5">
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-[10px] sm:text-[11px] md:text-xs text-gray-300">
            {infoItems.map((item, index) => (
              <div 
                key={item.label} 
                className="group flex items-center gap-1.5 px-2 py-1.5 rounded-lg hover:bg-white/5 transition-all duration-300"
              >
                <div className="transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12">
                  {item.icon}
                </div>
                <span className="whitespace-normal text-center md:text-left font-medium group-hover:text-white transition-colors duration-300">
                  {item.label}
                </span>

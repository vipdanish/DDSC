        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2 space-y-8 animate-fade-in">
            ...
            <div className="flex space-x-6">
              ...
              <a href="https://chat.whatsapp.com/IUyUuEGG66K4OPzrh4YsZb" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-green-500/30 p-5 rounded-2xl transition-all duration-500 hover:scale-125 hover:-rotate-12 group backdrop-blur-md border border-white/20 hover:border-green-400/50">

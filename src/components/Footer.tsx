        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2 space-y-8 animate-fade-in">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/ddsc.club/" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-pink-500/30 p-4 rounded-full transition-all duration-300 hover:scale-110 hover:rotate-6 group backdrop-blur-sm border border-white/10">
                <Instagram className="h-6 w-6 text-white group-hover:text-pink-400 transition-colors" />
              </a>
              <a href="https://www.linkedin.com/in/dcodeclub" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-blue-500/30 p-4 rounded-full transition-all duration-300 hover:scale-110 hover:-rotate-6 group backdrop-blur-sm border border-white/10">
                <Linkedin className="h-6 w-6 text-white group-hover:text-blue-400 transition-colors" />
              </a>
              <a href="mailto:ddsc.team@gmail.com" className="bg-white/10 hover:bg-red-500/30 p-4 rounded-full transition-all duration-300 hover:scale-110 hover:rotate-6 group backdrop-blur-sm border border-white/10">
                <Mail className="h-6 w-6 text-white group-hover:text-red-400 transition-colors" />
              </a>
              <a href="https://chat.whatsapp.com/IUyUuEGG66K4OPzrh4YsZb" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-green-500/30 p-4 rounded-full transition-all duration-300 hover:scale-110 hover:-rotate-6 group backdrop-blur-sm border border-white/10">
                <svg className="h-6 w-6 text-white group-hover:text-green-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className="group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:ddsc.team@gmail.com" className="text-gray-300 hover:text-white transition-colors text-lg">
                      ddsc.team@gmail.com
                    </a>
                  </div>
                </div>
